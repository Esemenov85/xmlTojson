...
def get_spisok(get_xml):
    root = ET.parse(get_xml).getroot()   # получаем доступ к xml файлу
    doc = xml.dom.minidom.parse(get_xml);    # используем функцию parse() для загрузки и парсинга XML файла
